...
/*------------------------------------------------------------------------------
** Configuration of max process data size
**------------------------------------------------------------------------------
*/
#define ABCC_CFG_MAX_PROCESS_DATA_SIZE             ( 1024 )
...
#define ABCC_API_COMMAND_RESPONSE_LIST \
   ...
   ABCC_APPLICATION_OBJ_VENDOR_NAME_GET_VALUE("DTL"), \
   ABCC_ETHERNETIP_OBJ_VENDOR_ID_GET_VALUE(0xDEAD), \
...
#define ABCC_CFG_DEBUG_HEXDUMP_SPI_ENABLED 1
